...
void openAcc(){
	...
	cout<< "Confirm security pin: "; cin>>pin2; //getline(cin, pin2); cout<<endl;
	if(pin1!=pin2){cout<< "Pin don't match, try again..."<<endl;}}while(pin1!=pin2);
...
void accDet(){
    ...
    if(accNum=="41184676334"){
		cout<<"Enter security pin: "; cin>>pin; 
		if(pin==pin1){
